...
@interface systemhelpController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	SystemHelp;
- (UMLayoutView*)SystemHelp BV_OBJC_METHOD_FAMILY_NONE;
