...
@interface teamtypeController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	TeamType;
- (UMLayoutView*)TeamType BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* picker0;

@property (nonatomic,strong) UMView* button1;

@property (nonatomic,strong) UMView* picker0_0;

@property (nonatomic,strong) UMView* picker0_1;

@property (nonatomic,strong) UMView* picker0_2;
