...
@interface clockinginController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ClockingIn;
- (UMLayoutView*)ClockingIn BV_OBJC_METHOD_FAMILY_NONE;
