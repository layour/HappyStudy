...
@interface examtopicController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ExamTopic;
- (UMLayoutView*)ExamTopic BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* checkbox5;

@property (nonatomic,strong) UMView* label8;

@property (nonatomic,strong) UMView* checkbox6;

@property (nonatomic,strong) UMView* label9;

@property (nonatomic,strong) UMView* checkbox7;
...
@property (nonatomic,strong) UMView* checkbox8;

@property (nonatomic,strong) UMView* label12;

@property (nonatomic,strong) UMView* checkbox9;

@property (nonatomic,strong) UMView* label13;

@property (nonatomic,strong) UMView* checkbox10;

@property (nonatomic,strong) UMView* label14;

@property (nonatomic,strong) UMView* checkbox11;
