...
@interface chapterexerciseController ()
{
...
@implementation chapterexerciseController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize ChapterExercise = _ChapterExercise;
...
static NSString *controllerC = @"ChapterExerciseController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ChapterExercise addSubUMView:_viewPage0];
     //设置控件基本属性
    ...
    _navigatorbar0.naviTitle = [UMParser parseExpr:nil expr:@"章节练习" ctx:_ctx];;
...
// --listviewdefine0
    _listviewdefine0 = [UMControl creatControl:@"UMXTableView" container:self  params:@{
                          ...
                          @"layout":@"Layout_vbox",
                          @"width":@"fill",
                          @"onitemclick":@"listviewdefine0_onitemclick",
                          @"valign":@"TOP",@"value":@"             \n        "}];
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.closeChapterExercise()" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"listviewdefine0_onload" method:@"this.loadChapter()" sender:sender]];
...
- (void)listviewdefine0_onitemclick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"listviewdefine0_onitemclick" method:@"this.enterExerciseTopic()" sender:sender]];
