...
@interface opinionticklingController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	OpinionTickling;
- (UMLayoutView*)OpinionTickling BV_OBJC_METHOD_FAMILY_NONE;
