...
@interface statisticsController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Statistics;
- (UMLayoutView*)Statistics BV_OBJC_METHOD_FAMILY_NONE;
