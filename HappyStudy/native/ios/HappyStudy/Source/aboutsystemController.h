...
@interface aboutsystemController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	AboutSystem;
- (UMLayoutView*)AboutSystem BV_OBJC_METHOD_FAMILY_NONE;
