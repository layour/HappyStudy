#import "clockinginController_listviewdefine0.h"
@interface clockinginController_listviewdefine0_tableViewCell ()
{
	
}
@end
@implementation clockinginController_listviewdefine0_tableViewCell
...
// --label1
    _label1 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"2015-05-26 15:59:00"}];
...
-(void)bindAll:(UMEntityContext *)_ctx{
	...
	[self umcontrol:_label1 controlid:@"label1" bindfield:@"time"];
[self umcontrol:_label2 controlid:@"label2" bindfield:@"type"];
...
@interface clockinginController_listviewdefine0_group ()
{
	
}
@end
@implementation clockinginController_listviewdefine0_group
...
@interface clockinginController_listviewdefine0_cellHeight ()
{
	
}
@end
@implementation clockinginController_listviewdefine0_cellHeight
