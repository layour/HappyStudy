...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    _welcomepage = [[CustomUI_welcomepageController alloc] initWithParentCtl:nil];
    [_navigationCtl pushViewController:_welcomepage animated:YES];
