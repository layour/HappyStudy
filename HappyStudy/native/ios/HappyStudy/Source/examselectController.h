...
@interface examselectController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ExamSelect;
- (UMLayoutView*)ExamSelect BV_OBJC_METHOD_FAMILY_NONE;
