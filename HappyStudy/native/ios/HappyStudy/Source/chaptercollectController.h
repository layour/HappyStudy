...
@interface chaptercollectController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ChapterCollect;
- (UMLayoutView*)ChapterCollect BV_OBJC_METHOD_FAMILY_NONE;
