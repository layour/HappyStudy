...
@interface chaptercollectController ()
{
...
@implementation chaptercollectController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize ChapterCollect = _ChapterCollect;
...
static NSString *controllerC = @"ChapterCollectController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ChapterCollect addSubUMView:_viewPage0];
     //设置控件基本属性
    ...
    _navigatorbar0.naviTitle = [UMParser parseExpr:nil expr:@"收藏错题" ctx:_ctx];;
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.closeChapterCollect()" sender:sender]];
