...
@interface opiniondetailController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	OpinionDetail;
- (UMLayoutView*)OpinionDetail BV_OBJC_METHOD_FAMILY_NONE;
