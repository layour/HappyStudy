...
@interface chapterexerciseController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ChapterExercise;
- (UMLayoutView*)ChapterExercise BV_OBJC_METHOD_FAMILY_NONE;
