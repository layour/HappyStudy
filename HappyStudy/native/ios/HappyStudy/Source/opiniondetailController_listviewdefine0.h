...
@interface opiniondetailController_listviewdefine0_tableViewCell:LHTableViewCell
...
@interface opiniondetailController_listviewdefine0_group : LHGroup
...
@interface opiniondetailController_listviewdefine0_cellHeight : NSObject
@property (strong) UMLayoutView* panel0;
- (UMLayoutView*)panel0 BV_OBJC_METHOD_FAMILY_NONE;
