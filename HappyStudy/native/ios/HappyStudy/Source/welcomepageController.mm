...
@interface welcomepageController ()
{
...
static NSString *controllerC = @"WelcomePageController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_WelcomePage addSubUMView:_viewPage0];
     //设置控件基本属性
...
[self panel0_onload:nil  args:nil];
...
- (void)panel0_onload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"panel0_onload" method:@"this.panel0_onload()" sender:sender]];
