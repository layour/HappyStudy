...
@interface exercisetopicController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ExerciseTopic;
- (UMLayoutView*)ExerciseTopic BV_OBJC_METHOD_FAMILY_NONE;
