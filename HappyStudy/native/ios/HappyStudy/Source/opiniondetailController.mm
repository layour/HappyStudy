...
@interface opiniondetailController ()
{
...
@synthesize OpinionDetail = _OpinionDetail;
...
static NSString *controllerC = @"OpinionDetailController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_OpinionDetail addSubUMView:_viewPage0];
     //设置控件基本属性
    ...
    _navigatorbar0.naviTitle = [UMParser parseExpr:nil expr:@"意见记录" ctx:_ctx];;
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.closeOpinionDetail()" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"listviewdefine0_onload" method:@"this.loadOpinion()" sender:sender]];
