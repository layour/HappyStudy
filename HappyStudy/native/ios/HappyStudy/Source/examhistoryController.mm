...
@interface examhistoryController ()
{
...
@implementation examhistoryController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize ExamHistory = _ExamHistory;
...
static NSString *controllerC = @"ExamHistoryController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ExamHistory addSubUMView:_viewPage0];
     //设置控件基本属性
    ...
    _navigatorbar0.naviTitle = [UMParser parseExpr:nil expr:@"考试记录" ctx:_ctx];;
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.closeExamHistory()" sender:sender]];
