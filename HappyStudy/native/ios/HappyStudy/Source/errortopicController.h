...
@interface errortopicController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ErrorTopic;
- (UMLayoutView*)ErrorTopic BV_OBJC_METHOD_FAMILY_NONE;
