...
@interface welcomepageController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	WelcomePage;
- (UMLayoutView*)WelcomePage BV_OBJC_METHOD_FAMILY_NONE;
