...
@interface examhistoryController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ExamHistory;
- (UMLayoutView*)ExamHistory BV_OBJC_METHOD_FAMILY_NONE;
