...
@interface errortopicController ()
{
...
static NSString *controllerC = @"ErrorTopicController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ErrorTopic addSubUMView:_viewPage0];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.closeErrorTopic()" sender:sender]];
