...
static NSString *controllerC = @"ExamTopicController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ExamTopic addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --imagebutton3
    _imagebutton3 = [UMControl creatControl:@"UMXImageButton" container:self  params:@{
                          ...
                          @"checked":@"false",
                          @"icon-text-spacing":@"0"}];
    [(UMLayoutView*)_navigatorbar0 addSubUMXView:_imagebutton3];
...
// --imagebutton4
    _imagebutton4 = [UMControl creatControl:@"UMXImageButton" container:self  params:@{
                          ...
                          @"checked":@"false",
                          @"icon-text-spacing":@"0"}];
    [(UMLayoutView*)_navigatorbar0 addSubUMXView:_imagebutton4];
...
[_flipperdefine0 addView:_panel5];
     //设置控件基本属性
    ...
    _panel10.layoutType = Layout_vbox;
[_flipperdefine0 addView:_panel10];
     //设置控件基本属性
...
// --checkbox0
    ...
    [(UMLayoutView*)_panel1 addSubUMXView:_checkbox0];
...
// --checkbox1
    _checkbox1 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"check-on-image":@"checkbox_select",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel2 addSubUMXView:_checkbox1];
...
// --checkbox2
    _checkbox2 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"check-on-image":@"checkbox_select",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel3 addSubUMXView:_checkbox2];
...
// --checkbox3
    _checkbox3 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"check-on-image":@"checkbox_select",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel4 addSubUMXView:_checkbox3];
...
// --label6
    ...
    [(UMLayoutView*)_panel5 addSubUMView:_panel7];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel5 addSubUMView:_panel8];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel5 addSubUMView:_panel9];
     //设置控件基本属性
...
// --checkbox4
    _checkbox4 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"checked":@"checked",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel6 addSubUMXView:_checkbox4];
...
// --checkbox5
    _checkbox5 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"check-on-image":@"checkbox_select",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel7 addSubUMXView:_checkbox5];
...
// --checkbox6
    _checkbox6 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"check-on-image":@"checkbox_select",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel8 addSubUMXView:_checkbox6];
...
// --checkbox7
    _checkbox7 = [UMControl creatControl:@"UMXXCheckBox" container:self  params:@{
                          ...
                          @"check-on-image":@"checkbox_select",
                          @"check-off-image":@"checkbox_noselect",@"value":@""}];
    [(UMLayoutView*)_panel9 addSubUMXView:_checkbox7];
...
// --label11
    ...
    [(UMLayoutView*)_panel10 addSubUMView:_panel11];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel10 addSubUMView:_panel13];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel10 addSubUMView:_panel14];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"button0_onclick" method:@"this.closeExamTopic()" sender:sender]];
