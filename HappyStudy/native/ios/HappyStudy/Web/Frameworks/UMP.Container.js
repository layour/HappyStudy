...
function UMP$UI$Container$UMJS$showLoadingBar(){
	//显示loading：
	return $service.call("UMJS.showLoadingBar",{});
}
function UMP$UI$Container$UMJS$hideLoadingBar(){
	//隐藏loading：
	return $service.call("UMJS.hideLoadingBar",{});
}
function UMP$UI$Container$UMJS$toast(msg){
...
function UMP$UI$Container$UMJS$refresh(args){
	$service.call("UMJS.refresh", args, false);//非同步调用
}
function UMP$UI$Container$UMJS$getTimeTicks(){
	return $service.call("UMJS.getTimeTicks", {}, true);
}
function UMP$UI$Container$UMJS$randomUUID(){
	return $service.call("UMJS.randomUUID", {}, true);
}
function UMP$UI$Container$UMJS$urlDecode(content){
...
function UMP$UI$Container$UMJS$urlEncode(content){
...
function UMP$UI$Container$UMJS$backConfirm(){
	//Android - 对物理back添加监听事件，弹出对话框：
	return $service.call("UMJS.addback", {}, false);
}
UMP.UI.Container.UMJS.prototype ={
	getTimeTicks : UMP$UI$Container$UMJS$getTimeTicks,
	randomUUID : UMP$UI$Container$UMJS$randomUUID,
	urlDecode : UMP$UI$Container$UMJS$urlDecode,
	urlEncode : UMP$UI$Container$UMJS$urlEncode,
	showLoadingBar : UMP$UI$Container$UMJS$showLoadingBar,
	hideLoadingBar : UMP$UI$Container$UMJS$hideLoadingBar,
	toast : UMP$UI$Container$UMJS$toast,
	refresh : UMP$UI$Container$UMJS$refresh,
	runjs : UMP$UI$Container$UMJS$runjs,
	backConfirm : UMP$UI$Container$UMJS$backConfirm
}
UMP.UI.Container.UMJS.registerClass('UMP.UI.Container.UMJS');
$js = new UMP.UI.Container.UMJS();
$toast = $js.toast;
UMP.UI.Container.UMEncryption=function(){
}

function UMP$UI$Container$UMEncryption$md5HexUtf8(data){
	var json = data;
...
UMP.UI.Container.UMEncryption.prototype ={
	md5HexUtf8 : UMP$UI$Container$UMEncryption$md5HexUtf8,
	md5 : UMP$UI$Container$UMEncryption$md5HexUtf8
}
UMP.UI.Container.UMEncryption.registerClass('UMP.UI.Container.UMEncryption');
$encryption = new UMP.UI.Container.UMEncryption();
