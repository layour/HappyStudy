...
public abstract class ExamHistoryActivity extends UMWindowActivity {

	protected UMWindow ExamHistory = null;
...
protected XHorizontalLayout panel2 = null;
	...
	protected final static int ID_EXAMHISTORY = 442023088;
protected final static int ID_VIEWPAGE0 = 878164048;
protected final static int ID_NAVIGATORBAR0 = 961714594;
protected final static int ID_BUTTON0 = 704144471;
protected final static int ID_LABEL0 = 1015014301;
protected final static int ID_BUTTON1 = 101290227;
protected final static int ID_LISTVIEWDEFINE0 = 603053786;
protected final static int ID_PANEL0 = 1828627339;
protected final static int ID_PANEL1 = 889019825;
protected final static int ID_LABEL1 = 1932313562;
protected final static int ID_PANEL3 = 610142128;
protected final static int ID_LABEL2 = 722226585;
protected final static int ID_LABEL3 = 832364136;
protected final static int ID_PANEL2 = 1432358060;
...
super.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("ExamHistory",ID_EXAMHISTORY);
  ...
  idmap.put("panel2",ID_PANEL2);
    ...
    UMEventArgs args = new UMEventArgs(ExamHistoryActivity.this);
...
label3_binder.setBindInfo(new BindInfo("time"));
...
label1_binder.setBindInfo(new BindInfo("index"));
...
ExamHistory = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_EXAMHISTORY
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"controller","ExamHistoryController"
,"valign","TOP"
,"namespace","com.layou.study"
);
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup,configure);
ExamHistory.addView(viewPage0);

return (UMWindow)ExamHistory;
}
  ...
  this.getContainer().exec(actionid, "this.closeExamHistory()",UMActivity.getViewId(control),args);
}
public void actionListviewdefine0_onload(View control, UMEventArgs args) {
    ...
    args.put("containerName","");
  ActionProcessor.exec(this, actionid, args);
  this.getContainer().exec(actionid, "this.loadExamHistory()",UMActivity.getViewId(control),args);
}
public void actionListviewdefine0_onitemclick(View control, UMEventArgs args) {
    ...
    args.put("containerName","");
  ActionProcessor.exec(this, actionid, args);
  this.getContainer().exec(actionid, "this.enterExamHistoryTopic()",UMActivity.getViewId(control),args);
}
