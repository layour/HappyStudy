...
public abstract class ChapterExerciseActivity extends UMWindowActivity {

	protected UMWindow ChapterExercise = null;
...
protected XHorizontalLayout panel2 = null;
	...
	protected final static int ID_CHAPTEREXERCISE = 777110280;
protected final static int ID_VIEWPAGE0 = 114989177;
protected final static int ID_NAVIGATORBAR0 = 1983210866;
protected final static int ID_BUTTON0 = 1947197053;
protected final static int ID_LABEL0 = 784096738;
protected final static int ID_LISTVIEWDEFINE0 = 1472748330;
protected final static int ID_PANEL0 = 858174005;
protected final static int ID_PANEL1 = 1622637609;
protected final static int ID_LABEL3 = 613967217;
protected final static int ID_PANEL3 = 1888670755;
protected final static int ID_LABEL1 = 1558083963;
protected final static int ID_LABEL2 = 969189218;
protected final static int ID_PANEL2 = 1659832639;

	
	
	@Override
	public String getControllerName() {
		return "ChapterExerciseController";
	}
...
super.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("ChapterExercise",ID_CHAPTEREXERCISE);
  ...
  idmap.put("panel2",ID_PANEL2);
    ...
    UMEventArgs args = new UMEventArgs(ChapterExerciseActivity.this);
...
ChapterExercise = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_CHAPTEREXERCISE
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
,"controller","ChapterExerciseController"
,"valign","TOP"
,"namespace","com.layou.study"
);
View viewPage0 = (View) getViewPage0View((UMActivity)context,binderGroup,configure);
ChapterExercise.addView(viewPage0);

return (UMWindow)ChapterExercise;
}
  ...
  this.getContainer().exec(actionid, "this.closeChapterExercise()",UMActivity.getViewId(control),args);
}
