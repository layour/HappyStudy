...
protected XHorizontalLayout panel2 = null;
	...
	protected final static int ID_OPINIONDETAIL = 655522487;
protected final static int ID_VIEWPAGE0 = 1063097462;
protected final static int ID_NAVIGATORBAR0 = 1883841865;
protected final static int ID_BUTTON0 = 171311767;
protected final static int ID_LABEL0 = 539208143;
protected final static int ID_LISTVIEWDEFINE0 = 1866767249;
protected final static int ID_PANEL0 = 1608164608;
protected final static int ID_PANEL1 = 1959802468;
protected final static int ID_LABEL1 = 1536044903;
protected final static int ID_LABEL2 = 2032733741;
protected final static int ID_PANEL2 = 117305571;
...
super.setContentView(currentPage);
  ...
  idmap.put("panel2",ID_PANEL2);
    ...
    UMEventArgs args = new UMEventArgs(OpinionDetailActivity.this);
...
label1_binder.setBindInfo(new BindInfo("content"));
...
label2_binder.setBindInfo(new BindInfo("time"));
...
public void actionListviewdefine0_onload(View control, UMEventArgs args) {
    ...
    args.put("containerName","");
  ActionProcessor.exec(this, actionid, args);
  this.getContainer().exec(actionid, "this.loadOpinion()",UMActivity.getViewId(control),args);
}
