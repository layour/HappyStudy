...
public abstract class ExamSelectActivity extends UMWindowActivity {

	protected UMWindow ExamSelect = null;
...
protected UMButton button1 = null;
	...
	protected final static int ID_EXAMSELECT = 390893150;
protected final static int ID_VIEWPAGE0 = 1297192126;
protected final static int ID_NAVIGATORBAR0 = 1637505081;
protected final static int ID_BUTTON0 = 87525684;
protected final static int ID_LABEL0 = 390343552;
protected final static int ID_BUTTON2 = 287303406;
protected final static int ID_PANEL0 = 1094586862;
protected final static int ID_IMAGEBUTTON0 = 153739163;
protected final static int ID_LABEL1 = 608592994;
protected final static int ID_LABEL2 = 2053182161;
protected final static int ID_LABEL3 = 1100684351;
protected final static int ID_LABEL4 = 1550427709;
protected final static int ID_LABEL5 = 2073741650;
protected final static int ID_BUTTON1 = 960196817;

	
	
	@Override
	public String getControllerName() {
		return "ExamSelectController";
	}
...
super.setContentView(currentPage);
	...
	private void registerControl() {
		  idmap.put("ExamSelect",ID_EXAMSELECT);
...
button0.setOnClickListener(new View.OnClickListener() {
  ...
  public void onClick(View v) {
    UMEventArgs args = new UMEventArgs(ExamSelectActivity.this);
...
,"font-family","default"
,"valign","center"
,"background-image","icon_menu.png"
);
...
ExamSelect = (UMWindow)ThirdControl.createControl(new UMWindow(context),ID_EXAMSELECT
,"halign","center"
,"height","fill"
,"layout","vbox"
,"width","fill"
...
ExamSelect.addView(viewPage0);

return (UMWindow)ExamSelect;
}
  ...
  this.getContainer().exec(actionid, "this.closeExamSelect()",UMActivity.getViewId(control),args);
}
public void actionButton2_onclick(View control, UMEventArgs args) {
    ...
    args.put("containerName","");
  ActionProcessor.exec(this, actionid, args);
  this.getContainer().exec(actionid, "this.openExamHistory()",UMActivity.getViewId(control),args);
}
