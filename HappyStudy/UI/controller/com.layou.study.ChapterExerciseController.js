...
function com$layou$study$ChapterExerciseController$loadChapter(sender, args){
	...
	$service.get({
		"url" : "http://10.2.112.27:8080/HappyStudyServer/chapter/mobileList",
...
function com$layou$study$ChapterExerciseController$enterExerciseTopic(sender, args){
	...
	var userId = $ctx.getApp("userId");
	$service.get({
		"url" : "http://10.2.112.27:8080/HappyStudyServer/topic/findTopicByUserChapter?search_chapterId=" + chapterId + "&search_userId=" + userId,
