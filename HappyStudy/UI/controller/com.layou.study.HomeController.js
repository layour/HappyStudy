...
function com$layou$study$HomeController$enterExerciseTopic(sender, args){
	...
	$service.get({
		"url" : "http://10.2.112.42:8080/HappyStudyServer/topic/findTopicByUser?search_userId=" + userId,
...
function com$layou$study$HomeController$enterNetworkErrorTopic(sender, args){
	...
	var userId = $ctx.getApp("userId");
	$service.get({
		"url" : "http://10.2.112.42:8080/HappyStudyServer/topic/findCollectByUser?search_userId=" + userId,
