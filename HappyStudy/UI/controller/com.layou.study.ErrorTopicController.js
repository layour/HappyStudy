...
try{
Type.registerNamespace('com.layou.study.ErrorTopicController');
com.layou.study.ErrorTopicController = function() {
    com.layou.study.ErrorTopicController.initializeBase(this);
    this.initialize();
}
function com$layou$study$ErrorTopicController$initialize(){
...
function com$layou$study$ErrorTopicController$closeErrorTopic(sender, args){
	$view.close();
}
function com$layou$study$ErrorTopicController$loadTopicFlipper(sender, args){
...
function com$layou$study$ErrorTopicController$selectA(sender, args){
	var flipperIndex = $id("flipperdefine0").get("viewindex");
	if(flipperIndex == 0){
...
function com$layou$study$ErrorTopicController$selectB(sender, args){
	var flipperIndex = $id("flipperdefine0").get("viewindex");
	if(flipperIndex == 0){
...
function com$layou$study$ErrorTopicController$selectC(sender, args){
	var flipperIndex = $id("flipperdefine0").get("viewindex");
	if(flipperIndex == 0){
		$id("checkbox0").setAttribute("checked", "false");
		$id("checkbox1").setAttribute("checked", "false");
...
function com$layou$study$ErrorTopicController$selectD(sender, args){
	var flipperIndex = $id("flipperdefine0").get("viewindex");
	if(flipperIndex == 0){
		$id("checkbox0").setAttribute("checked", "false");
		$id("checkbox1").setAttribute("checked", "false");
...
function com$layou$study$ErrorTopicController$showAnalysis(sender, args){
	var flipperIndex = $id("flipperdefine0").get("viewindex");
...
function com$layou$study$ErrorTopicController$loadProviousTopicFlipper(sender, args){
	//判断详解状态
	var flipperIndex = $id("flipperdefine0").get("viewindex");
	if(flipperIndex == 0){
...
function com$layou$study$ErrorTopicController$loadNextTopicFlipper(sender, args){
	//判断详解状态
	var flipperIndex = $id("flipperdefine0").get("viewindex");
	if(flipperIndex == 0){
		var display = $id("label6").get("display");
...
com.layou.study.ErrorTopicController.prototype = {
    loadNextTopicFlipper : com$layou$study$ErrorTopicController$loadNextTopicFlipper,
    loadProviousTopicFlipper : com$layou$study$ErrorTopicController$loadProviousTopicFlipper,
    showAnalysis : com$layou$study$ErrorTopicController$showAnalysis,
    selectD : com$layou$study$ErrorTopicController$selectD,
    selectC : com$layou$study$ErrorTopicController$selectC,
    selectB : com$layou$study$ErrorTopicController$selectB,
    selectA : com$layou$study$ErrorTopicController$selectA,
    loadTopicFlipper : com$layou$study$ErrorTopicController$loadTopicFlipper,
    closeErrorTopic : com$layou$study$ErrorTopicController$closeErrorTopic,
    initialize : com$layou$study$ErrorTopicController$initialize,
    evaljs : com$layou$study$ErrorTopicController$evaljs
};
com.layou.study.ErrorTopicController.registerClass('com.layou.study.ErrorTopicController',UMP.UI.Mvc.Controller);
}catch(e){$e(e);}
