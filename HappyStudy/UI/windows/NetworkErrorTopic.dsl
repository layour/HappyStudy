...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="NetworkErrorTopic" controller="NetworkErrorTopicController" namespace="com.layou.study">
    <import ref="NetworkErrorTopic.css" type="css"/>
    ...
    <div id="viewPage0">
        ...
        <flipper id="flipperdefine0" onnextflipper="this.loadNextTopicFlipper()" onload="this.loadTopicFlipper()" onpreviousflipper="this.loadProviousTopicFlipper()" viewindex="0">
            ...
            <div id="panel5" title="页面2">
                ...
                <label id="label12" type="multiline">答案：B</label> 
            </div>
            <div id="panel10" title="页面3">
                ...
                <label id="label18" type="multiline">答案：C</label> 
            </div> 
        </flipper> 
    </div> 
</window>
