    ...
    <div id="viewPage0">
        ...
        <flipper id="flipperdefine0" viewindex="0">
            ...
            <div id="panel5" title="页面2">
                <label id="label6" type="multiline">根据我国消费者权益保护法的规定，消费者协会履行的职能之一是？ </label>
                <div id="panel6">
                    <input id="checkbox4" type="checkbox" checked="checked"/>
                    <label id="label7" type="multiline">参与生产企业的年度生产计划的制定</label> 
                </div>
                <div id="panel7">
                    <input id="checkbox5" type="checkbox"/>
                    <label id="label8" type="multiline">受理经营者的投诉，并对投诉事项进行调查、调解</label> 
                </div>
                <div id="panel8">
                    <input id="checkbox6" type="checkbox"/>
                    <label id="label9" type="multiline">参与销售企业市场开拓计划的制定</label> 
                </div>
                <div id="panel9">
                    <input id="checkbox7" type="checkbox"/>
                    <label id="label10" type="multiline">对损害消费者合法权益的行为，通过大众传播媒介予以揭露、批评</label> 
                </div> 
            </div>
